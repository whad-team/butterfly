...
ESBPacket::ESBPacket(uint8_t *packetBuffer, size_t packetSize, uint32_t timestamp, uint8_t source, uint8_t channel, int8_t rssi, CrcValue crcValue, ESBApplicativeLayer applicativeLayer) : Packet(ESB_PACKET_TYPE, packetBuffer, packetSize, timestamp, source, channel, rssi, crcValue){
...
ESBApplicativeLayer ESBPacket::getApplicativeLayer() {
